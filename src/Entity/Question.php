...
class Question
{
    ...
    #[Assert\Length(min: 10, minMessage: 'Veuillez détaillez votre titre', max: 255, maxMessage: 'Titre trop long')]
    private ?string $title = null;

    #[ORM\Column(type: Types::TEXT)]
    #[Assert\NotBlank(message: 'Veuillez détailler votre question')]
    #[Assert\Length(min: 50, minMessage: 'Veuillez détailler un peu plus votre question')]
